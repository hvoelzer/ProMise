<template>
    <div>
        ...
        />
        <table style="width: 100%;" v-if="isEventLogReady">
            <thead>
                <tr>
...
<!--
    <tr v-for="(row, rowKey) in form.content.data" v-bind:key="'row-'+rowKey">
                    <td v-for="(column, columnKey) in form.content.meta.fields" v-bind:key="'row-'+rowKey+'-column-'+columnKey">
                            {{form.content.data[rowKey][column]}}>
                    </td>
                </tr>
-->
